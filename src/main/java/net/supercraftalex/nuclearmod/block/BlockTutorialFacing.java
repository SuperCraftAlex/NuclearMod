...
import net.supercraftalex.nuclearmod.tileentity.TileEntityTutorialFacing;
...
public class BlockTutorialFacing extends ModBlock implements ITileEntityProvider {
	...
	public BlockTutorialFacing() {
		...
		GameRegistry.registerTileEntity(TileEntityTutorialFacing.class, new ResourceLocation(ModConstants.MODID, "tutblockfacing"));
	}
